...
frappe.provide("tokhna_peru.libro_electronico_de_inventario_permanente_valorizado");
...
frappe.ui.form.on('Libro Electronico de Inventario Permanente Valorizado', 'periodo', function(frm) {
	tokhna_peru.libro_electronico_de_inventario_permanente_valorizado.check_mandatory_to_set_button(frm);
...
tokhna_peru.libro_electronico_de_inventario_permanente_valorizado.check_mandatory_to_set_button = function(frm) {
...
tokhna_peru.libro_electronico_de_inventario_permanente_valorizado.check_mandatory_to_fetch = function(doc) {
...
frappe.ui.form.on("Libro Electronico de Inventario Permanente Valorizado", "get_data", function(frm) {
	tokhna_peru.libro_electronico_de_inventario_permanente_valorizado.check_mandatory_to_fetch(frm.doc);
	frappe.call({
