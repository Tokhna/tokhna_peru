...
frappe.provide("tokhna_peru.libro_electronico_de_compras");
...
frappe.ui.form.on('Libro Electronico de Compras', 'year', function(frm) {
	tokhna_peru.libro_electronico_de_compras.check_mandatory_to_set_button(frm);	
});
...
tokhna_peru.libro_electronico_de_compras.check_mandatory_to_set_button = function(frm) {
...
tokhna_peru.libro_electronico_de_compras.check_mandatory_to_fetch = function(doc) {
...
frappe.ui.form.on("Libro Electronico de Compras", "get_data", function(frm) {
	tokhna_peru.libro_electronico_de_compras.check_mandatory_to_fetch(frm.doc);
	frappe.call({
