...
frappe.provide("tokhna_peru.reporte_de_libros_electronicos");
...
frappe.ui.form.on('Reporte de Libros Electronicos', 'tipo_libro', function(frm) {
	tokhna_peru.reporte_de_libros_electronicos.check_mandatory_to_set_button(frm);
...
tokhna_peru.reporte_de_libros_electronicos.check_mandatory_to_set_button = function(frm) {
...
tokhna_peru.reporte_de_libros_electronicos.check_mandatory_to_fetch = function(doc) {
...
frappe.ui.form.on("Reporte de Libros Electronicos", "get_data", function(frm) {
	tokhna_peru.reporte_de_libros_electronicos.check_mandatory_to_fetch(frm.doc);
	frappe.call({
		method: "make_report",
		doc: frm.doc,
		args: {
