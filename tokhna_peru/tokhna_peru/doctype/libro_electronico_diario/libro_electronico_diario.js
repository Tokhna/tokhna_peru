...
frappe.provide("tokhna_peru.libro_electronico_diario");
...
frappe.ui.form.on('Libro Electronico Diario', 'year', function(frm) {
	tokhna_peru.libro_electronico_diario.check_mandatory_to_set_button(frm);
...
frappe.ui.form.on('Libro Electronico Diario', 'company', function(frm, cdt, cdn) {
	tokhna_peru.libro_electronico_diario.check_mandatory_to_set_button(frm, cdt, cdn);
});
tokhna_peru.libro_electronico_diario.check_mandatory_to_set_button = function(frm) {
...
tokhna_peru.libro_electronico_diario.check_mandatory_to_fetch = function(doc) {
...
frappe.ui.form.on("Libro Electronico Diario", "get_data", function(frm) {
	tokhna_peru.libro_electronico_diario.check_mandatory_to_fetch(frm.doc);
	frappe.call({
